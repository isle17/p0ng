...
COORDINATES_PADDLE_ONE = [(600, 40), (600, 20), (600, 0), (600, -20), (600, -40)]
COORDINATES_PADDLE_TWO = [(-600, 40), (-600, 20), (-600, 0), (-600, -20), (-600, -40)]
...
paddle1 = Paddle(coordinates=COORDINATES_PADDLE_ONE)
paddle2 = Paddle(coordinates=COORDINATES_PADDLE_TWO)
ball = Ball()
